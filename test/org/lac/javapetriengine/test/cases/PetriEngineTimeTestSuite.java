...
public class PetriEngineTimeTestSuite {
	...
	/**
	 * Creates factory, timed petri and engine from given PNML
	...
	private void setUpEngine(String PNML){
		...
		engine = new PetriEngine(timedPetriNet, policy);
	}
	...
	public void testAThreadGoesToVardCondQueueWhenAnotherThreadIsSleepingIntoTransition() {
		...
		assertEquals(true, t0.getTimeSpan().anySleeping());
		assertEquals(true, engine.getQueuesState()[0]);
	...
	public void testThreadShouldSleepInVarcondQueueWhenTransitionGetsDisabledWhileSleepingByItself() {
		...
		Assert.assertArrayEquals(expectedQueuesState, engine.getQueuesState());
	...
	public void testThreadPerennialFiringATransitionBeforeItsTimeSpanShouldSleepOnItsOwnAndThenFire(){
		...
		Assert.assertFalse(engine.getQueuesState()[0]);
	 ...
	 */
	@Test
	public void testEngineShouldRestartTheEnablingTimesAndHasNoRaceTimeCondition(){
		
		setUpEngine(PETRI_FOR_INITIALIZATION_TIME);
	 ...
	 */
	@Test
	public void testEngineShouldThrowAnExceptionWhenThreadTriesToFireBeforeInitializePetriNet(){
	 ...
	 */
	@Test
	public void testEngineShouldNotInitializePetriNetAfterFiringANonTimedTransition(){
		
		setUpEngine(PETRI_FOR_INITIALIZATION_TIME2);
	...
	*/
	...
	public void testThreadWhoSleptWaitingForTimeSpanShouldHavePriorityOverIncomingThreads(){
		...
		setUpEngine(TIMED_PETRI_NET_02);
