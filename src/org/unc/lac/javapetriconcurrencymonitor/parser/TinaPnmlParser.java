...
/**
 * Concrete implementation of PnmlParser for TINA's PNML format.
 */
public class TinaPnmlParser extends PnmlParser {
	...
	public TinaPnmlParser(String pnmlPath) throws FileNotFoundException, SecurityException, NullPointerException {
		super(pnmlPath);
	}
