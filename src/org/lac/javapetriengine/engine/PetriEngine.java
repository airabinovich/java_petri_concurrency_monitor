package org.lac.javapetriengine.engine;
...
import org.lac.javapetriengine.queues.FairQueue;
import org.lac.javapetriengine.queues.VarCondQueue;
...
public class PetriEngine {
	...
	public PetriEngine(final PetriNet _petri, TransitionsPolicy _policy) {
	 ...
	 * @throws NotInitializedPetriNetException when firing a timed transition before initializing the petri net
	 * @see PetriEngine#fireTransition(Transition)
	 */
