package org.lac.javapetriengine.petrinets;
...
public abstract class PetriNet {
	 ...
	 * Intended only for internal using. Use {@link org.lac.javapetriengine.engine.PetriEngine#setGuard(String, boolean)} instead 
